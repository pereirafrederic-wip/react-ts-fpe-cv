    ...
    <div className="tile Identite">
      <div className="tile is-20 is-parent">
        ...
        <div className="tile is-7 is-child Identite__civilite">
          <div className="Identite__civilite__nomprenom">{`${data.nom} ${
            data.prenom
          }`}</div>
          <div className="Identite__civilite__email">{`${data.email}`}</div>
          <div className="Identite__civilite__age">{`${moment().diff(
            data.dateNaissance,
            "year"
          )} ans`}</div>
        </div>
      </div>
      <div className="tile is-20 is-parent Identite__titre">
        <div className="tile is-20 is-child Identite__titre">
